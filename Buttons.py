...
import re
import random
from Graphs import (refresh_graph1,
                    refresh_graph2,
                    refresh_graph3,
                    refresh_graph4,
                    refresh_graph5,
...
def Edit_btn(self):
    ...
    unwrap_shadow(self.ui.Edit_button)
    wrap_with_shadow(self.ui.Save_button, 70)
    wrap_with_shadow(self.ui.Cancel_button2, 70)
...
def Save_btn_(self):
    ...
    wrap_with_shadow(self.ui.Edit_button, 70)
    unwrap_shadow(self.ui.Save_button)
    unwrap_shadow(self.ui.Cancel_button2)
...
def Edit_btn2(self):
    ...
    unwrap_shadow(self.ui.Edit_button2)
    wrap_with_shadow(self.ui.Save_button2, 70)
    wrap_with_shadow(self.ui.Cancel_button3, 70)
...
def Canceled2(self):
    ...
    wrap_with_shadow(self.ui.Edit_button2, 70)
    unwrap_shadow(self.ui.Save_button2)
    unwrap_shadow(self.ui.Cancel_button3)
...
def students_clicked(self):
    ...
    wrap_with_shadow(self.ui.Add_button, 70)
    wrap_with_shadow(self.ui.Cancel_button, 70)
...
def Grades_clicked(self):
    ...
    wrap_with_shadow(self.ui.Edit_button3, 70)
...
def Grades_top(self):
    ...
    self.ui.Edit_button4.setGeometry(
        QRect(810, 500, 91, 31))
    wrap_with_shadow(self.ui.Edit_button4, 70)
    unwrap_shadow(self.ui.Cancel_button5)
    unwrap_shadow(self.ui.Save_button4)
    self.ui.Cancel_button5.hide()
    ...
    unwrap_shadow(self.ui.Edit_button3)
    unwrap_shadow(self.ui.tableWidget_subjects)
...
def Edit_btn3(self):
    ...
    self.ui.Edit_button3.hide()
    unwrap_shadow(self.ui.Edit_button3)
    wrap_with_shadow(self.ui.Save_button3, 70)
    wrap_with_shadow(self.ui.Cancel_button4, 70)
...
def Canceled3(self):
    ...
    self.ui.Edit_button3.setGeometry(QRect(810, 500, 91, 31))
    wrap_with_shadow(self.ui.Edit_button3, 70)
    unwrap_shadow(self.ui.Save_button3)
    unwrap_shadow(self.ui.Cancel_button4)
    self.ui.Save_button3.hide()
    self.ui.Cancel_button4.hide()
    self.ui.errlbl3.hide()
...
def Edit_btn_4(self):
    self.ui.Edit_button4.hide()
    unwrap_shadow(self.ui.Edit_button4)
    ...
    wrap_with_shadow(self.ui.Save_button4, 70)
    wrap_with_shadow(self.ui.Cancel_button5, 70)
