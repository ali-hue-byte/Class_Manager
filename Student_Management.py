...
from Graphs import (refresh_graph3,
                    refresh_graph4,
                    refresh_graph5,
                    refresh_graph6,
                    refresh_graph7)

from Tables import (refresh_attendance,
                    refresh_grades,
                    refresh_view)
from Buttons import (Edit_btn,
                     Save_btn_,
                     Canceled,
                     Edit_btn2,
                     Canceled2,
...
class Main_app(QMainWindow):
    def __init__(self):
        ...
        self.widgets = {self.ui.Firstnameline: ["widgets_to_clear", "widgets_student_add", "widget_student_edit"],
                        ...
                        self.ui.dateEdit: ["widgets_student_add", "widget_student_edit"],
                        ...
                        self.ui.Add_button: ["widgets_student_add"],
                        self.ui.Cancel_button: ["widgets_student_add"],
                        ...
                        self.ui.Save_button: ["widgets_student_view"],
                        self.ui.Cancel_button2: ["widgets_student_view"],
                        self.ui.Edit_button: ["widgets_student_view"],
                        ...
                        self.ui.Save_button2: ["widgets_class"],
                        self.ui.Cancel_button3: ["widgets_class"],
                        self.ui.Edit_button2: ["widgets_class"],
                        ...
                        self.ui.Edit_button3: ["widgets_grades"],
                        self.ui.Save_button3: ["widgets_grades"],
                        self.ui.Cancel_button4: ["widgets_grades"],
                        self.ui.errlbl3: ["widgets_grades", "error_labels"],
                        self.ui.Cancel_button5: ["widgets_grades"],
                        self.ui.Edit_button4: ["widgets_grades"],
                        self.ui.Save_button4: ["widgets_grades"],
                        ...
                        self.ui.performane: ["widgets_statistics","widgets_statistics3","widgets_statistics_2","widgets_statistics_4"],
                        ...
                        self.ui.subject_avaeges: ["widgets_statistics"],
        ...
        # Add page
        self.ui.Add_button.clicked.connect(lambda: add_btn_clicked(self))
        self.ui.Cancel_button.clicked.connect(lambda: cancel_clicked(self))
        # View page
        ...
        self.ui.performane.clicked.connect(lambda: performance(self))
        ...
        self.ui.Edit_button.clicked.connect(lambda : Edit_btn(self))
        self.ui.Cancel_button2.clicked.connect(lambda : Canceled(self))
        self.ui.Save_button.clicked.connect(lambda : Save_btn_(self))
        self.ui.Edit_button2.clicked.connect(lambda : Edit_btn2(self))
        self.ui.Cancel_button3.clicked.connect(lambda : Canceled2(self))
        self.ui.Save_button2.clicked.connect(lambda : Save_btn_2(self))


        self.ui.Edit_button3.clicked.connect(lambda : Edit_btn3(self))
        self.ui.Cancel_button4.clicked.connect(lambda : Canceled3(self))
        self.ui.Save_button3.clicked.connect(lambda : Save_btn_3(self))
        self.ui.Edit_button4.clicked.connect(lambda : Edit_btn_4(self))
        self.ui.Cancel_button5.clicked.connect(lambda : Canceled4(self))
        self.ui.Save_button4.clicked.connect(lambda : Save_btn_4(self))
